...
export const RegisterForm = ({ toggleForm }: { toggleForm: () => void }) => {
  return (
    <Card className="w-full max-w-md bg-black border border-purple-500 py-12 px-6">
      <CardBody className="p-6">
        <div className="flex flex-col items-center justify-center text-white">
          ...
          <button className="w-full py-3 px-4 border border-purple-500 text-purple-500 rounded hover:bg-gray-800 hover:text-white focus:outline-none">
            Register
          </button>
          <p className="mt-8">
